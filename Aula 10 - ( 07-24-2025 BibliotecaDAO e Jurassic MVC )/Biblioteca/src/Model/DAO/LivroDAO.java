...
public class LivroDAO {
    ...
    public Livro buscarPorId(int id) {
        String sql = "SELECT id_livro, titulo_livro, autor_livro, genero_livro, isbn_livro FROM livro WHERE id_livro = ? ";
    ...
    public List<Livro> buscarPorTitulo(String tituloBusca) {
        ...
        String sql = "SELECT id_livro, titulo_livro, autor_livro, genero_livro, isbn_livro FROM livro WHERE titulo_livro ILIKE ? ORDER BY titulo_livro DESC";
        try (Connection conn = ConexaoBiblioteca.conectar();
             PreparedStatement stmt = conn.prepareStatement(sql)) {

...
public class AlunoDAO {
    ...
    public Aluno buscarPorId(int id) {
        String sql = "SELECT id_aluno, nome_aluno, idade_aluno, contato_aluno FROM aluno WHERE id_aluno = ? ";
        try (Connection conn = ConexaoBiblioteca.conectar();
             PreparedStatement stmt = conn.prepareStatement(sql)) {
            stmt.setInt(1, id);
    ...
    public List<Aluno> buscarPorNome(String nomeBusca) {
        List<Aluno> alunos = new ArrayList<>();
        String sql = "SELECT id_aluno, nome_aluno, idade_aluno, contato_aluno FROM aluno WHERE nome_aluno ILIKE ? ORDER BY nome_aluno";
        try (Connection conn = ConexaoBiblioteca.conectar();
             PreparedStatement stmt = conn.prepareStatement(sql)) {
